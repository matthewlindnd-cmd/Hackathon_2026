...
3. For best results, use a simple local server.
   Example in VS Code: install Live Server and open index.html.

What it does:
- lets the user select a train or bus route
